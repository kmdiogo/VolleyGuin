    ...
    return (
        <form autoComplete="off">
            <Grid container spacing={3}>
                ...
                <Grid item xs={6}>
                    <KeyboardDatePicker required label="Start Date" fullWidth {...bindStartDate} inputVariant="outlined" />
                </Grid>
                <Grid item xs={6}>
                    <KeyboardDatePicker required label="End Date" fullWidth {...bindEndDate} inputVariant="outlined" />
                </Grid>
            </Grid>
        </form>
    )
